	...
	<section class="wrapper">
		...
		<section class="panel" style="margin-bottom: 10px">
			<div class="panel-body">
				<form role="form" id="create" action="board" method="POST" class="form-horizontal tasi-form">
		...
		<section class="panel">
			<div class="panel-body">
				<form role="form" id="update" action="board" method="POST" class="form-horizontal tasi-form">
					<div class="form-group has-success">
						<label class="col-lg-2 control-label"><strong>Catégorie</strong></label>
		...
		<section class="panel">
			<div class="panel-body">
				<form role="form" id="delete "action="board" method="POST" class="form-horizontal tasi-form">
					<div class="form-group has-success">
						<label class="col-lg-2 control-label"><strong>Catégorie</strong></label>
						<select name="boardId" class="form-control">
							<c:forEach var="board" items="${boards}">
