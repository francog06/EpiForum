...
<meta name="description" content="Epiforum: page de désincription">
...
<body>
	<div id="wrap">
		...
		<div id="page-body">
			<form action="unsubscribe" method="POST" id="unsubscribe">
				<div class="panel">
					<div class="inner"><span class="corners-top"><span></span></span>
						<div class="content">
							...
							<fieldset class="fields1">
								...
								<dl>
									<input type="submit" name="unsubscribe" tabindex="6" value="Valider" class="button1"/>
								</dl>
							</fieldset>
						</div>
